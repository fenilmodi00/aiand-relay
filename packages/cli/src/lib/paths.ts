...
/**
 * Resolve the aiandrelay home directory - the one source of truth for where
 * the pid file, the sqlite session database, and the codex-app registration
 * file live. Replaces the four byte-identical `resolveAiandrelayHome()`
 ...
 */
export function aiandrelayHome(): string {
